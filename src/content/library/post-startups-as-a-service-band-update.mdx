...
heroImage: '../../images/library/startup-as-a-service/t3-AZlNU3U2kDCX7bBHnD.png'
...
<MarkdownPostImage path="startup-as-a-service/_startup-as-a-service-4-b-p.003.png" alt="Startups as a Service Band" class="shadow-lg" />
...
<MarkdownPostImage path="startup-as-a-service/_startup-as-a-service-4-b-p.005.png" alt="Startups as a Service Band" class="shadow-lg" />
...
<MarkdownPostImage path="startup-as-a-service/_startup-as-a-service-4-b-p.007.png" alt="Startups as a Service Band" class="shadow-lg" />
...
<MarkdownPostImage path="startup-as-a-service/_startup-as-a-service-4-b-p.009.png" alt="Startups as a Service Band" class="shadow-lg" />
